...
{
    public class BaseTestApp : NetDaemon.Common.NetDaemonApp { }

    public class BaseTestRxApp : NetDaemon.Common.Reactive.NetDaemonRxApp { }

    public partial class DaemonHostTestBase : IAsyncLifetime
    {
        private readonly NetDaemon.Common.NetDaemonApp _defaultDaemonApp;
        ...
        private readonly Mock<NetDaemon.Common.Reactive.NetDaemonRxApp> _defaultMockedRxApp;
        ...
        internal DaemonHostTestBase()
        {
            ...
            _defaultMockedRxApp = new Mock<NetDaemon.Common.Reactive.NetDaemonRxApp>() { CallBase = true };
        ...
        public NetDaemon.Common.NetDaemonApp DefaultDaemonApp => _defaultDaemonApp;
        ...
        public Mock<NetDaemon.Common.Reactive.NetDaemonRxApp> DefaultMockedRxApp => _defaultMockedRxApp;
