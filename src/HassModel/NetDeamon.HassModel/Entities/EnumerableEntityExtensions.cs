...
public static class EnumerableEntityExtensions
{
    ...
    /// </code>
    /// </example>
    public static IObservable<StateChange> StateAllChanges(this IEnumerable<IEntityTarget> entities) => 
    ...
    /// </code>
    /// </example>
    public static IObservable<StateChange> StateChanges(this IEnumerable<IEntityTarget> entities) =>
    ...
    public static void CallService(this IEnumerable<IEntityTarget> entities, string service, object? data = null)
    {
